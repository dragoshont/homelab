# Define the content for the README.md file using a here-string.
$readmeContent = @"
...
# Define the file path for the README.md (in the current directory)
$readmePath = "README.md"

# Write the content to the file (overriding any existing file)
Set-Content -Path $readmePath -Value $readmeContent -Force

Write-Output "README.md has been generated at: $(Resolve-Path $readmePath)"
